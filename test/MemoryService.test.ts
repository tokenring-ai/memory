...
describe("MemoryService", () => {
  ...
  it("should clear all memories", () => {
    ...
    memoryService.addMemory("Memory 1");
    memoryService.addMemory("Memory 2");
  ...
  it("should add and retrieve attention items correctly", async () => {
    ...
    // Test unshift method
    memoryService.unshiftAttentionItem(
      "important",
  ...
  it("should splice attention items correctly", () => {
    ...
    // Insert an item
    memoryService.spliceAttentionItems(
      "important",
      1,
      0,
      "Inserted Item",
    ...
    expect(memoryService.attentionItems.important).toHaveLength(3);
    expect(memoryService.attentionItems.important[0]).toBe("Item 1");
    expect(memoryService.attentionItems.important[1]).toBe(
      "Inserted Item",
    );
    ...
    expect(memoryService.attentionItems.newType[0]).toBe(
      "First new type item",
    );
  });
